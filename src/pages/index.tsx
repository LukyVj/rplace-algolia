    ...
    if (isExplorer) {
      snapshotIndex
        ...
        .then(() => {
          ...
          allSnapshots &&
            console.log(
              new Date(allSnapshots[selectedSnapshot].timestamp * 1000)
            );
        });
    }
  }, [isExplorer]);
  ...
  return (
    <div>
      ...
      <Disclaimer
        ...
        setHasDisclaimer={setHasDisclaimer}
      />
        ...
        <nav className="w-100">
          ...
          {isExplorer && allSnapshots ? (
            <>
              ...
              />
              <p>
                <b>Amount of snapshots: {maxSnapshot}</b>
              </p>
              <p>
                <b>Current snapshot</b>: {selectedSnapshot}{" "}
              </p>
              {allSnapshots && (
                <p>
                  ...
                  <time>
                    {new Date(
                      allSnapshots[selectedSnapshot].timestamp * 1000
                    ).toLocaleString()}
                  </time>
                </p>
              )}
